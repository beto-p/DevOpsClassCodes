...
designed. Please note this example uses and requires Java 8 to work..  test test test test test writing anything and now later add a build pipeline plugin.
